...
def Control(angle, sign_car_side, real_car_signal_distance):  
    if real_car_signal_distance < 1.2:
        if (sign_car_side == 'right' and angle < 16 and angle > 6):
            Straight_slow()
        elif (sign_car_side == 'right' and angle >= 16 and angle <= 58):
            Turn_right_small_near(angle)
        elif (sign_car_side == 'right' and angle > 58 and angle <= 90):
        ...
        if (sign_car_side == 'right' and angle < 10 and angle > 4):
            ...
            Turn_right_big_far()
            # add loc
        elif (sign_car_side == 'right' and angle > 140 and angle <= 165) or (sign_car_side == 'left' and angle > 110 and angle <= 121):
            Turn_right_big_far()
            sleep(0.2)
        elif (sign_car_side == 'right' and angle > 165) or (sign_car_side == 'left' and angle > 135):
            Turn_right_big_far()
