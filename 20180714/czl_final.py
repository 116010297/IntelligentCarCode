...
def Turn_right_small_near(angle):
    str_angle = str(int(round((angle - 16)/1.6 + 95))).rjust(3,'0')
    s = '090000'+str_angle
    ser.write(s)
...
def Turn_right_mid_near(angle):
    ...
    str_angle = str(int(round((angle - 16)/1 + 103))).rjust(3,'0')
    s = '095000'+str_angle
    ser.write(s)
...
def Turn_left_small_near(sign_car_side, angle):
    if sign_car_side == 'right':
        str_angle = str(int(round((angle - 16)/2.4 + 85))).rjust(3,'0')
...
def Turn_left_mid_near(angle):
    ...
    str_angle = str(int(round((angle-16)/(-1) + 90))).rjust(3,'0')
...
def Turn_right_small_far(angle):
    str_angle = str(int(round((angle - 16)/1.6 + 92))).rjust(3,'0')
...
def Turn_right_mid_far(angle):
    str_angle = str(int(round((angle - 16)/1.5 + 90))).rjust(3,'0')
...
def Turn_left_small_far(sign_car_side, angle):
    if sign_car_side == 'right':
        str_angle = str(int(round((angle - 16)/2 + 85))).rjust(3,'0')  
...
def Control(angle, sign_car_side, real_car_signal_distance):  
    if real_car_signal_distance < 1.2:
        if (sign_car_side == 'right' and angle > 6 and angle <= 16):
            Straight_slow()
        ...
        elif (sign_car_side == 'right' and angle > 90 and angle <= 130):
            Turn_right_big_near()
        elif (sign_car_side == 'right' and angle > 130 and angle <= 155):
            Turn_right_big_near()
            sleep(0.2)
        elif (sign_car_side == 'right' and angle > 165) or (sign_car_side == 'left' and angle > 155):
            Turn_right_big_near()
            sleep(0.4)
        elif (sign_car_side == 'right' and angle <= 8) or (sign_car_side == 'left' and angle <= 14):
            Turn_left_small_near(sign_car_side, angle)
        elif (sign_car_side == 'left' and angle > 14 and angle <= 24):
            Straight_slow() 
        elif (sign_car_side == 'left' and angle > 24 and angle <= 90):
            Turn_left_mid_near(angle)
        elif (sign_car_side == 'left' and angle > 90 and angle <= 130):
            Turn_left_big_near()
        elif (sign_car_side == 'left' and angle > 130 and angle <= 155):
            Turn_left_big_near()
            sleep(0.2)
        else:
            Stop_control()   
    else:
        if (sign_car_side == 'right' and angle > 4 and angle <= 10):
            Straight_fast()
        elif (sign_car_side == 'right' and angle > 10 and angle <= 52):
