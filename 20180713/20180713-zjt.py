...
def Turn_right_small_near(angle):
    str_angle = str(int(round((angle - 24)/1.6 + 101))).rjust(3,'0')
    s = '100000'+str_angle
    ser.write(s)
...
def Turn_right_mid_near(angle):
    ...
    str_angle = str(int(round((angle - 24)/1.6 + 89))).rjust(3,'0')
    s = '097000'+str_angle
    ser.write(s)
...
def Turn_left_small_near(sign_car_side, angle):
    if sign_car_side == 'right':
        str_angle = str(int(round((angle - 24)/1.6 + 85))).rjust(3,'0')
...
def Turn_right_small_far(angle):
    str_angle = str(int(round((angle - 24)/1.6 + 110))).rjust(3,'0')
...
def Turn_right_mid_far(angle):
    str_angle = str(int(round((angle - 24)/1.6 + 115))).rjust(3,'0')
...
def Turn_left_small_far(sign_car_side, angle):
    if sign_car_side == 'right':
        ...
        str_angle = str(int(round(angle/(-2) + 90))).rjust(3,'0') 
    s = '102000'+str_angle
    ser.write(s)
